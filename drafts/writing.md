...
syntax highlighting in CSS can be found [here](https://github.com/namvnngu/namvnngu.github.io/blob/main/src/styles/code.css).
...
5. Run `scripts/block.sh` with the block name (i.e. `header`). The script can be found

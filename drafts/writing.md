...
The source code of my new website can be found [here](https://github.com/namvnngu/namvnngu.github.io).
...
then adjusted and improved it to align with my preferences. My improved version
of code syntax highlighting in CSS can be found [here](https://github.com/namvnngu/namvnngu.github.io/blob/main/src/styles/code.css).
...
non-interactive. It can perform basic text editing operations of a minimal
